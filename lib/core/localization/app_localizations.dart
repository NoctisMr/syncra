...
/// Motor de traducciones de Syncra Premium.
/// Centraliza todos los textos de la app para un fácil mantenimiento y escalabilidad.
class AppLocalizations {
  static const Map<String, Map<String, String>> _translations = {
    'es': {
      ...
      'ocr_error': 'Ocurrió un error al escanear la imagen.',
      'ocr_no_numeric_found': 'No se encontraron valores numéricos válidos.',
    },
    'en': {
      ...
      'ocr_error': 'An error occurred while scanning the image.',
      'ocr_no_numeric_found': 'No valid numeric values were found.',
    },
    'pt': {
      ...
      'ocr_error': 'Ocorreu um erro ao escanear a imagem.',
      'ocr_no_numeric_found': 'Nenhum valor numérico válido foi encontrado.',
    }
  };

  /// Función de conveniencia para obtener la traducción de forma segura.
  /// Retorna la clave exacta (en lugar de crashear) si un desarrollador futuro
  /// intenta buscar una palabra que no ha sido añadida.
